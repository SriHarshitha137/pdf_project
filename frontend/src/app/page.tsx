...
const CONVERT_OPTIONS: Record<string, { toolId: string; label: string }[]> = {
  pdf:  [
    ...
    { toolId: "pdf2png",  label: "PDF → PNG" },
    { toolId: "pdf2word", label: "PDF → Word" },
    { toolId: "pdf2excel",label: "PDF → Excel" },
    { toolId: "pdf2text", label: "PDF → Text" },
    { toolId: "pdf2html", label: "PDF → HTML" },
    { toolId: "pdf2ppt",  label: "PDF → PPT" },
    { toolId: "pdf2epub", label: "PDF → EPUB" },
  ],
  jpg:  [{ toolId: "jpg2pdf", label: "Image → PDF" }, { toolId: "jpg2png", label: "JPG → PNG" }],
  jpeg: [{ toolId: "jpg2pdf", label: "Image → PDF" }, { toolId: "jpg2png", label: "JPG → PNG" }],
  png:  [{ toolId: "jpg2pdf", label: "Image → PDF" }, { toolId: "png2jpg", label: "PNG → JPG" }, { toolId: "png2webp", label: "PNG → WEBP" }],
  webp: [{ toolId: "jpg2pdf", label: "Image → PDF" }, { toolId: "webp2jpg", label: "WEBP → JPG" }],
  doc:  [{ toolId: "word2pdf", label: "Word → PDF" }, { toolId: "word2txt", label: "Word → TXT" }, { toolId: "word2html", label: "Word → HTML" }, { toolId: "word2markdown", label: "Word → Markdown" }],
  docx: [{ toolId: "word2pdf", label: "Word → PDF" }, { toolId: "word2txt", label: "Word → TXT" }, { toolId: "word2html", label: "Word → HTML" }, { toolId: "word2markdown", label: "Word → Markdown" }],
  xls:  [{ toolId: "excel2pdf", label: "Excel → PDF" }, { toolId: "excel2csv", label: "Excel → CSV" }, { toolId: "excel2json", label: "Excel → JSON" }],
  xlsx: [{ toolId: "excel2pdf", label: "Excel → PDF" }, { toolId: "excel2csv", label: "Excel → CSV" }, { toolId: "excel2json", label: "Excel → JSON" }],
  ppt:  [{ toolId: "ppt2pdf", label: "PPT → PDF" }, { toolId: "ppt2images", label: "PPT → Images" }],
  pptx: [{ toolId: "ppt2pdf", label: "PPT → PDF" }, { toolId: "ppt2images", label: "PPT → Images" }],
  json: [{ toolId: "json2csv", label: "JSON → CSV" }, { toolId: "json2xml", label: "JSON → XML" }],
  csv:  [{ toolId: "csv2json", label: "CSV → JSON" }],
  xml:  [{ toolId: "xml2json", label: "XML → JSON" }],
  yaml: [{ toolId: "yaml2json", label: "YAML → JSON" }],
  yml:  [{ toolId: "yaml2json", label: "YAML → JSON" }],
  epub: [{ toolId: "epub2pdf", label: "EPUB → PDF" }],
  mobi: [{ toolId: "mobi2epub", label: "MOBI → EPUB" }],
  azw3: [{ toolId: "azw32pdf", label: "AZW3 → PDF" }],
};
...
const OTHER_ACTIONS: Record<string, { toolId: string; label: string; icon: string | string[] }[]> = {
  ...
  jpg:  [
    { toolId: "compressjpg", label: "Compress", icon: ["M4 14h6v6","M20 10h-6V4","M14 10l7-7","M3 21l7-7"] },
    { toolId: "image2text", label: "OCR", icon: ["M15 3h4a2 2 0 012 2v14a2 2 0 01-2 2h-4","M10 17l5-5-5-5","M13.8 12H3"] },
    { toolId: "removebackground", label: "Remove BG", icon: ["M4 16l4.586-4.586a2 2 0 012.828 0L16 16","M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"] },
    { toolId: "upscaleimage", label: "Upscale", icon: "M13 2L3 14h9l-1 8 10-12h-9l1-8z" },
  ],
  jpeg: [
    { toolId: "compressjpg", label: "Compress", icon: ["M4 14h6v6","M20 10h-6V4","M14 10l7-7","M3 21l7-7"] },
    { toolId: "image2text", label: "OCR", icon: ["M15 3h4a2 2 0 012 2v14a2 2 0 01-2 2h-4","M10 17l5-5-5-5","M13.8 12H3"] },
  ...
  png:  [
    { toolId: "compresspng", label: "Compress", icon: ["M4 14h6v6","M20 10h-6V4","M14 10l7-7","M3 21l7-7"] },
    { toolId: "image2text", label: "OCR", icon: ["M15 3h4a2 2 0 012 2v14a2 2 0 01-2 2h-4","M10 17l5-5-5-5","M13.8 12H3"] },
    { toolId: "removebackground", label: "Remove BG", icon: ["M4 16l4.586-4.586a2 2 0 012.828 0L16 16","M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"] },
    { toolId: "upscaleimage", label: "Upscale", icon: "M13 2L3 14h9l-1 8 10-12h-9l1-8z" },
  ],
  webp: [
    { toolId: "compresswebp", label: "Compress", icon: ["M4 14h6v6","M20 10h-6V4","M14 10l7-7","M3 21l7-7"] },
    { toolId: "image2text", label: "OCR", icon: ["M15 3h4a2 2 0 012 2v14a2 2 0 01-2 2h-4","M10 17l5-5-5-5","M13.8 12H3"] },
    { toolId: "upscaleimage", label: "Upscale", icon: "M13 2L3 14h9l-1 8 10-12h-9l1-8z" },
  ],
};
